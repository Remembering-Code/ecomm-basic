        ...
        <div>
            ...
            <div className='p-4 flex justify-evenly items-center'>
                ...
                <div className='right-description font-bold border p-2 leading-loose text-center w-80'>
                    <h1 className='text-2xl'> {item.PRD_NAME}</h1>
                    <p className='text-lg text-green-500'> ${item.PRD_PRICE} </p>
                    {/* <p className='text-sm'> {item.PRD_DESCRIPTION} </p> */}
                    <p className=''> size </p>
                    <select className='font-normal border border-black w-20'> Size
                    ...
                    <p> Quantity </p>
                    <select className='font-normal border border-black w-20'> Quantity
